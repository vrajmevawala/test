    ...
    try {
      ...
      const [{ result }] = await chrome.scripting.executeScript({
        ...
        func: () => {
          ...
          // 2. Try to find the first code block (GitHub, StackOverflow)
  ...
  return (
    <div className="popup-container">
      ...
      <header style={{
        ...
        <div style={{ flex: 1 }}>
           <h1 style={{ fontSize: 15, fontWeight: 700, margin: 0 }}>CodeOpt <span style={{ color: 'var(--accent)', fontSize: 11, fontWeight: 500 }}>Extension</span></h1>
        </div>
      ...
      <footer style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          ...
          <span>CodeOptimizer v1.0.0 — Always Secure</span>
        </div>
      </footer>
    </div>
  );
