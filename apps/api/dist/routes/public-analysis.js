...
import { z } from 'zod';
import { buildAnalysisSystemPrompt, buildAnalysisUserPrompt, getTreeSitterAnalysis, buildASTContext } from '@codeopt/utils';
const groq = new Groq({
...
export const publicAnalysisRoute = async (app) => {
    app.post('/analyze-direct', {
        ...
        try {
            ...
            const rawDeductions = (issues.filter((i) => i.severity === 'error').length * 12 +
...
//# sourceMappingURL=public-analysis.js.map